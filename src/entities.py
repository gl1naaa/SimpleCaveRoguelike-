...
MONSTER_TYPES = {
    "rat":       {"char": "r", "color": "150,120,80",   "hp": 8,   "atk": 3,  "xp": 5,  "speed": 1.5},
    "bat":       {"char": "b", "color": "120,80,160",   "hp": 6,   "atk": 2,  "xp": 4,  "speed": 2.0},
    "goblin":    {"char": "g", "color": "0,180,0",      "hp": 15,  "atk": 5,  "xp": 10, "speed": 1.0},
    "skeleton":  {"char": "S", "color": "220,220,220",  "hp": 20,  "atk": 7,  "xp": 15, "speed": 0.8},
    "spider":    {"char": "s", "color": "80,80,80",     "hp": 12,  "atk": 4,  "xp": 8,  "speed": 1.8},
    "slime":     {"char": "J", "color": "50,200,50",    "hp": 25,  "atk": 3,  "xp": 12, "speed": 0.5},
    "orc":       {"char": "O", "color": "100,160,50",   "hp": 35,  "atk": 10, "xp": 25, "speed": 0.7},
    "wraith":    {"char": "W", "color": "150,150,255",  "hp": 30,  "atk": 12, "xp": 30, "speed": 1.2},
    "demon":     {"char": "D", "color": "255,50,0",     "hp": 50,  "atk": 15, "xp": 50, "speed": 0.9},
    "dragon":    {"char": "K", "color": "255,100,0",    "hp": 100, "atk": 25, "xp": 100,"speed": 0.6},
}
...
BOSS_TYPES = {
    "Goblin King":  {"char": "G", "color": "0,255,0",   "hp": 80,  "atk": 12, "xp": 80},
    "Lich":         {"char": "L", "color": "100,0,255", "hp": 120, "atk": 18, "xp": 150},
    "Minotaur":     {"char": "M", "color": "180,100,0", "hp": 150, "atk": 22, "xp": 200},
    "Dragon Lord":  {"char": "F", "color": "255,80,0",  "hp": 200, "atk": 30, "xp": 300},
}
...
class Boss(Entity):
    ...
    def take_damage(self, dmg: int) -> int:
        ...
        if self.alive and self.hp < self.max_hp * 0.5 and self.phase == 1:
            self.phase = 2
            self.speed = 0.8
        if self.alive and self.hp < self.max_hp * 0.25 and self.phase == 2:
            self.phase = 3
            self.speed = 1.2
        return dmg
...
class Chest(Entity):
    ...
    def generate_loot(self, floor: int = 1):
        from items import generate_random_item
        count = random.randint(1, 3)
        for _ in range(count):
            self.items.append(generate_random_item(floor))
